...
public class NetDao {
    ...
    public static void createLive(Context context, User user,
                                  OnCompletListener<String> listener) {
        OkHttpUtils<String> utils = new OkHttpUtils<>(context);
    ...
    public static void removeLive(Context context, String chatroomId,
                                  OnCompletListener<String> listener) {
        OkHttpUtils<String> utils = new OkHttpUtils<>(context);
    ...
    public static void loadAllGift(Context context,OnCompletListener<String> listener) {
        OkHttpUtils<String> utils = new OkHttpUtils<>(context);
    ...
    public static void givingGift(Context context, String username, String anchor, int giftId,
                                  int count, OnCompletListener<String> listener) {
        OkHttpUtils<String> utils = new OkHttpUtils<>(context);
